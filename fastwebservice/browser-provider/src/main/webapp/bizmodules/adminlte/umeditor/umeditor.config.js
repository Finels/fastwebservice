...
(function() {
    ...
    var rootURLDIR=URL.substring(0, URL.indexOf("bizmodules", URL.indexOf("://")));
    window.UMEDITOR_CONFIG = {
        ...
        toolbar: [
            ...
            'emotion | insertorderedlist insertunorderedlist | selectall cleardoc | fontfamily fontsize ',
            '| justifyleft justifycenter justifyright justifyjustify |',
            ' link unlink image ', //  video map 'formula'fontfamily fontsize'paragraph
