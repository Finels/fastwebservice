    ...
    $.fn.extend({
        slimScroll: function (options) {
            ...
            this.each(function () {
                    ...
                    //        if ("style" in el) {
                    //            if ("overflowY" in el.style) {
                    //                if ($(el).css("overflow-y") == "scroll" || $(el).css("overflow-y") == "auto") {
                    ...
                    //    }
                        ...
                        //    if (el.style.overflowX == "scroll" || el.style.overflowX == "auto") {
                    ...
                    function _onWheel(e) {
                        var is_not_model = true;
                        //var path = e.path;
                        ////判断div内部是否有出现纵向滚动条的div
                        //for (var i = 0; i < path.length; i++) {
                        //    var obj = path[i];
                        //    //if (obj.className == "modal-dialog") {
                        //    //    is_not_model = false;
                        //    //}
                        //    if (hasScrolled(obj)) {
                        //        is_not_model = false;
