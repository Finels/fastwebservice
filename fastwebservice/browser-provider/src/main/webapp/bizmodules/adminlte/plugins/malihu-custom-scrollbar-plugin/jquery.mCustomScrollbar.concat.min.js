...
!function (e) {
    ...
    !function (t) {
        ...
        var t, o = "mCustomScrollbar", a = "mCS", n = ".mCustomScrollbar", i = {
            ...
            scrollInertia: 0,//滚动的惯性值 在毫秒中 使用0可以无滚动惯性 (滚动惯性可以使区块滚动更加平滑)
            autoDraggerLength: !0,
            ...
            function t(t, a) {
                var llfp = jQuery(t.target).closest("span.combo,div.combo-p,div.menu");
                if (llfp.length) {
                    jQuery(llfp).find(".combo-f").each(function () {
            ...
            var b = o - _;
            if ("left" === t) {//如果是横向滚动
                var llf = jQuery('#' + e.id).parent().parent().siblings('.mCSB_container_wrapper').children('.mCSB_container')
                if(llf.length>0){//判断是否有该对象
                    var osleft = llf["0"].offsetLeft;//获取偏移量
                    jQuery('#' + e.id).parent().parent().parent().parent().siblings('.datagrid-header').scrollLeft(-osleft);//设置头部偏移量
                }
            }
