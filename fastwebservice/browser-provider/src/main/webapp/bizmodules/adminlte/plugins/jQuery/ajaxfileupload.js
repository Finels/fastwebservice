jQuery.extend({
    ...
    createUploadForm: function (id, fileElementId, data) {
        ...
        //创建文件元素
        var fileElementIdArr = fileElementId.split(",");
        for (var i in fileElementIdArr) {
            var file = fileElementIdArr[i];
            var fileId = 'jUploadFile' + file + id;
            var oldElement = jQuery('#' + file);
            var newElement = jQuery(oldElement).clone();
            jQuery(oldElement).attr('id', fileId);
            jQuery(oldElement).attr('name', file); //文件上传控件名
