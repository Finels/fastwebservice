...
(function($) {
	...
	DarkTooltip.prototype = {
		...
		setPositions: function(){
			...
			var test =this.tooltip.outerHeight();
			var test2 = this.tip.outerHeight();
			switch(this.options.gravity){
				case 'south':
					leftPos = this.bearer.outerWidth()/2 - this.tooltip.outerWidth()/2;
						//bearerLeft + this.bearer.outerWidth()/2 - this.tooltip.outerWidth()/2;
					topPos = 0- this.tooltip.outerHeight() - this.tip.outerHeight()/2;
						//bearerTop - this.tooltip.outerHeight() - this.tip.outerHeight()/2;
					break;
				case 'west':
