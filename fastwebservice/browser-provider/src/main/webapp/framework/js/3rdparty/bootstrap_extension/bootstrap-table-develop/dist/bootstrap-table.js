...
(function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        showRefresh: false,
        showToggle: false,
        showExportAll:false,                 //wangling add
        showSearchButton:true,                 //wangling add
        showResetButton:false,                 //wangling add
        buttonsAlign: 'right',
        smartDisplay: true,
        escape: false,
        ...
        icons: {
            ...
            exportAll:'fa fa-fw fa-indent',                      //wangling  add exportall icon 2017-8-9
    ...
    BootstrapTable.EVENTS = {
        ...
        'expandAll.bs.table': 'onExpandAll',
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        //wanling add select button 2017-9-13
        if (this.options.showSearchButton) {
            html.push( ' <a  itemid="item_search"  name="item_select" class="btn btn-default" style="border-radius:0px ;color: #337ab7" > <i class="fa fa-fw fa-search" ></i> <span name="text">查询</span>   </a>');
        }
        //wanling add reset button 2017-9-13
        if (this.options.showResetButton) {
            html.push( ' <a  itemid="item_reset"  name="item_reset" class="btn btn-default" > <i class="fa fa-fw fa-rotate-left" ></i> <span name="text">重置</span>  </a>');
        }
        ...
        if (this.options.showExportAll) {
            html.push(sprintf('<button class="btn' +
                    sprintf(' btn-%s', this.options.buttonsClass) +
                    sprintf(' btn-%s', this.options.iconSize) +
                    '" type="button" name="exportAll" style="border-radius: 0px" itemId="exportAll" aria-label="exportAll" title="全部导出">',
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            for (i = from; i <= to; i++) {
                html.push('<li class="page-number' + (i === this.options.pageNumber ? ' active' : '') + '">',
                    '<a href="javascript:void(0)">', i, '</a>',                    //wangling  2017-8-9 防止二次点击跳转到首页
                    '</li>');
            }
